  ...
  const headerContent = `
   ...
   <div class="preloader">
        <div class="logo-container">
            <!-- Using a placeholder logo with your color -->
          <!-- <div class="atp__pr">
            ATP
            </div> -->
        </div>
    ...
    <header class="header-inside" id="header-inside">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand logo__1" href="#"> <img class="two--sc--img" src="/themes/custom/atp/atp/assets/images/logo.png"></a>
          <a class="navbar-brand logo__2" href="#"> <img class="two--sc--img" src="/themes/custom/atp/atp/assets/images/logo-2.png"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="/Our_hestory.html">Agence</a></li>
              <li class="nav-item"><a class="nav-link" href="/Nos_projets.html">Projets</a></li>
              <li class="nav-item"><a class="nav-link" href="/carriere.html">Carrières</a></li>
